...
http.createServer(function(request,response) {
	request.on("end",function () {
		...
		response.write('<head><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" /></head><body><a href="/">Home</a><br /><br /><div id="data" style="float:left;margin-right:256px;margin-left:32px">');
		try {
